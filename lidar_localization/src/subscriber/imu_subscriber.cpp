...
namespace lidar_localization{
    ...
    void IMUSubscriber::msg_callback(const sensor_msgs::ImuConstPtr& imu_msg_ptr)
    {
        ...
        imu_data.augular_velocity.x = imu_msg_ptr->angular_velocity.x;
        imu_data.augular_velocity.y = imu_msg_ptr->angular_velocity.y;
        imu_data.augular_velocity.z = imu_msg_ptr->angular_velocity.z;
    ...
    void IMUSubscriber::ParseDate(std::deque<IMUData>& imu_data_buff)
    {
